...
function bodyTextByNotice(){
  ...
  if (notice === 'SECOND') {
    return `
      <p>This refers to your loan account with Agribusiness Banking Corporation - A Rural Bank covered by Promisory Note No. <strong>${acct}</strong> amounting to <strong>PHP ${loanAmt}</strong>, excluding penalties and interests which has been left unpaid since <strong>${dueDate}</strong> despite our initial notice and follow-ups.</p>
      <br>
  ...
  return `
    <p>This refers to your loan account with Agribusiness Banking Corporation - A Rural Bank covered by Promisory Note No. <strong>${acct}</strong> <i>with an outstanding balance amounting</i> of PHP <strong>${loanAmt}</strong>, excluding <i>interests and penalties.</i></p>
    <br>
